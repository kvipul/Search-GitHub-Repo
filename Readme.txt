...
More About This App:
    ...
    -This app doesn't authorize user to access GitHub API although you can uncomment the specify part of code to authorize for all the HttpRequest or any particular Httprequest with your username and password (i.e. Basic Authetication)